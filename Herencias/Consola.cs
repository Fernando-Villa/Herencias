...
namespace Herencias
{
    public class Consola
    {
        ...
        {
            Escribir(x, y, ConsoleColor.Yellow, "╔");
            Escribir(x2, y2, ConsoleColor.Red, "╝");
            Escribir(x, y2, ConsoleColor.Red, "╚");
            Escribir(x2, y, ConsoleColor.Yellow, "╗");
            for (int i = x + 1; i < x2; i++)
            {
                Escribir(i, y, ConsoleColor.Yellow, "═");
                Escribir(i, y2, ConsoleColor.Red, "═");
            }
            for (int i = y + 1; i < y2; i++)
            {
                Escribir(x, i, ConsoleColor.Blue, "║");
                Escribir(x2, i, ConsoleColor.Blue, "║");
            }
        }
        ...
        {
            Marco(25, 2, 65, 12);
            Escribir(35, 1, ConsoleColor.Red, "MENÚ DE OPCIONES");
            ...
            Escribir(35, 8, ConsoleColor.White, "FACTURACION");
        ...
        public void MenuOpcionesproducto()
        {
            ...
            Escribir(32, 5, ConsoleColor.Yellow, "2.- ");
            Escribir(35, 5, ConsoleColor.White, "BUSCAR PRODUCTO");
            Escribir(32, 6, ConsoleColor.Yellow, "3.- ");
            Escribir(35, 6, ConsoleColor.White, "ACTUALIZAR PRECIO DE PRODUCTO");
            Escribir(32, 7, ConsoleColor.Yellow, "4.- ");
            Escribir(35, 7, ConsoleColor.White, "MOSTRAR ITEMS..");
            Escribir(32, 8, ConsoleColor.Yellow, "5.- ");
            Escribir(35, 8, ConsoleColor.White, "ELIMINAR PRODUCTO");
            Escribir(32, 9, ConsoleColor.Yellow, "6.- ");
            Escribir(35, 9, ConsoleColor.White, "REGRESAR");
        }
        public void MenuOpcionesclientes()
        {
            ...
            Escribir(32, 7, ConsoleColor.Yellow, "4.- ");
            Escribir(35, 7, ConsoleColor.White, "ELIMINAR CLIENTES");
            Escribir(32, 8, ConsoleColor.Yellow, "5.- ");
            Escribir(35, 8, ConsoleColor.White, "AGREGAR CLIENTE VIP");
            Escribir(32, 9, ConsoleColor.Yellow, "6.- ");
            Escribir(35, 9, ConsoleColor.White, "MOSTRAR CLIENTES VIP");
            Escribir(32, 10, ConsoleColor.Yellow, "7.- ");
            Escribir(35, 10, ConsoleColor.White, "REGRESAR");
        }
        public void MenuOpcionesproveedor()
        {
            ...
            Escribir(35, 1, ConsoleColor.Red, "MENÚ DE OPCIONES");
            Escribir(32, 4, ConsoleColor.Yellow, "1.- ");
            Escribir(35, 4, ConsoleColor.White, "AGREGAR PROVEEDOR");
            Escribir(32, 5, ConsoleColor.Yellow, "2.- ");
            Escribir(35, 5, ConsoleColor.White, "LISTAR PROVEEDORES");
            Escribir(32, 6, ConsoleColor.Yellow, "3.- ");
            Escribir(35, 6, ConsoleColor.White, "BUSCAR PROVEEDOR");
            Escribir(32, 7, ConsoleColor.Yellow, "4.- ");
            Escribir(35, 7, ConsoleColor.White, "ELIMINAR PROVEEDOR");
            Escribir(32, 8, ConsoleColor.Yellow, "5.- ");
            Escribir(35, 8, ConsoleColor.White, "AGREGAR PEDIDO");
            Escribir(32, 9, ConsoleColor.Yellow, "6.- ");
            Escribir(35, 9, ConsoleColor.White, "MOSTRAR PEDIDO");
            Escribir(32, 10, ConsoleColor.Yellow, "7.- ");
            Escribir(35, 10, ConsoleColor.White, "REGRESAR");
        }
        public void MenuOpcionesempleado()
        {
            ...
            Escribir(35, 1, ConsoleColor.Red, "MENÚ DE OPCIONES");
            Escribir(32, 4, ConsoleColor.Yellow, "1.- ");
            Escribir(35, 4, ConsoleColor.White, "AGREGAR EMPLEADO");
            Escribir(32, 5, ConsoleColor.Yellow, "2.- ");
            Escribir(35, 5, ConsoleColor.White, "LISTAR EMPLEADOS");
            Escribir(32, 6, ConsoleColor.Yellow, "3.- ");
            Escribir(35, 6, ConsoleColor.White, "BUSCAR EMPLEADO");
            Escribir(32, 7, ConsoleColor.Yellow, "4.- ");
            Escribir(35, 7, ConsoleColor.White, "ELIMINAR EMPLEADO");
            Escribir(32, 8, ConsoleColor.Yellow, "5.- ");
            Escribir(35, 8, ConsoleColor.White, "AGREGAR HORARIO");
            Escribir(32, 9, ConsoleColor.Yellow, "6.- ");
            Escribir(35, 9, ConsoleColor.White, "MOSTRAR HORARIO");
            Escribir(32, 10, ConsoleColor.Yellow, "7.- ");
            Escribir(35, 10, ConsoleColor.White, "REGRESAR");
        }
